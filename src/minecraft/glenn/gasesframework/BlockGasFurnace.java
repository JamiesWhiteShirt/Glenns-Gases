...
public class BlockGasFurnace extends BlockContainer implements IGasReceptor
{
    ...
    {
        return GasesFramework.gasFurnaceIdle.blockID;
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, GasesFramework.gasFurnaceActive.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, GasesFramework.gasFurnaceIdle.blockID);
        }
