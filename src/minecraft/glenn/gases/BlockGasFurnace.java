...
public class BlockGasFurnace extends BlockContainer implements GasReceptor
{
    ...
    {
        return Gases.gasFurnaceIdle.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityGasFurnace tileentityfurnace = (TileEntityGasFurnace)par1World.getBlockTileEntity(par2, par3, par4);

            if (tileentityfurnace != null)
            {
                //par5EntityPlayer.displayGUIFurnace(tileentityfurnace);
            	par5EntityPlayer.openGui(Gases.instance, 0, par1World, par2, par3, par4);
            }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Gases.gasFurnaceActive.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Gases.gasFurnaceIdle.blockID);
        }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityGasFurnace)par1World.getBlockTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
