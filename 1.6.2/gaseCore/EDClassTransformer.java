...
public class EDClassTransformer implements IClassTransformer
{
	...
	public byte[] transform(String className, String arg1, byte[] data)
	{
		...
		{
			System.out.println("[GasesFrameworkCore]Patching class: " + className + "(Block)...");
		...
		{
			System.out.println("[GasesFrameworkCore]Patching class: " + className + "(BlockFire)...");
		...
		{
			System.out.println("[GasesFrameworkCore]Patching class: " + className + "(BlockFluid)...");
		...
		{
			System.out.println("[GasesFrameworkCore]Patching class: " + className + "(BlockFlowing)...");
		...
		if(newData != data)
		{
			System.out.println("[GasesCore]Patch OK!");
		}
